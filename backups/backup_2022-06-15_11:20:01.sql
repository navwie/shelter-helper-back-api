...
66	Персик	Хлопчик	12.jpeg	Пес	1	2022-05-23 20:57:10	2022-06-14 22:23:10	44	f	Дуже добрий	2020-12-31	2022-06-14	\N	\N
\.
...
3	dishes	wefwef	2022-05-23 21:14:01	2022-06-14 22:12:35	44	2022-06-14
...
SELECT pg_catalog.setval('public.animals_id_seq', 82, true);
...
SELECT pg_catalog.setval('public.oauth_clients_id_seq', 500, true);
...
SELECT pg_catalog.setval('public.oauth_personal_access_clients_id_seq', 250, true);
...
SELECT pg_catalog.setval('public.shelters_id_seq', 73, true);
