...
66	Персик	Хлопчик	12.jpeg	Пес	1	2022-05-23 20:57:10	2022-06-14 22:06:28	44	f	Дуже добрий	2020-12-31	2022-06-14	\N	\N
\.
...
SELECT pg_catalog.setval('public.animals_id_seq', 80, true);
...
SELECT pg_catalog.setval('public.oauth_clients_id_seq', 342, true);
...
SELECT pg_catalog.setval('public.oauth_personal_access_clients_id_seq', 171, true);
...
SELECT pg_catalog.setval('public.shelters_id_seq', 71, true);
